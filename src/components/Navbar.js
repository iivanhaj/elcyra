      ...
      <div className="container">
        ...
        <nav>
          <ul className="nav-links">
            ...
            <li><a href="/services" onMouseEnter={handleHover} onMouseLeave={handleHoverOut}>Our Services</a></li>
            <li><a href="/assignments" onMouseEnter={handleHover} onMouseLeave={handleHoverOut}>Assignments</a></li>
            <li><a href="/Packages" onMouseEnter={handleHover} onMouseLeave={handleHoverOut}>Packages</a></li>
